...
NOTE: 아래 목록에 컨트롤러 셸프(스토리지 시스템)가 표시되지 않으면 link:../getting-started/getup-run-concept.html["E-Series를 빠르게 시작합니다"^]를 참조하고 특정 스토리지 시스템에 대한 링크를 클릭하여 케이블 연결 정보에 액세스하십시오.
...
다음 구성 중 하나에 대해 케이블을 연결하는 경우 다음을 참조하십시오 https://mysupport.netapp.com/ecm/ecm_download_file/ECMLP2859057["기존 E27XX, E56XX 또는 EF560 컨트롤러 쉘프에 IOM 드라이브 쉘프를 추가합니다."^]
