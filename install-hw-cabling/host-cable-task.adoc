...
NOTE: 다음 정보는 모든 스토리지 시스템에 적용되는 것은 아닙니다. 스토리지 시스템별 호스트 케이블 연결에 대한 자세한 내용은 link:../getting-started/getup-run-concept.html["E-Series를 빠르게 시작합니다"^]을 참조하고 해당 스토리지 시스템 링크를 클릭하십시오.
