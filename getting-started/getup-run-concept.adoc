...
E-Series 하드웨어를 설치하려면 스토리지 어레이 및 셸프 유형(해당하는 경우)에 대한 설치 및 설정 지침을 참조하십시오.

[role="quick-margin-list"]
* link:../install-hw-ef50-ef80/install-workflow.html["EF50 또는 EF80 스토리지 시스템"^]
...
[role="quick-margin-list"]
* https://docs.netapp.com/us-en/e-series-santricity/system-manager/index.html["SANtricity System Manager 12.0x 온라인 도움말"^]
* https://docs.netapp.com/us-en/e-series-santricity-119/system-manager/index.html["11.9x에 대한 SANtricity 시스템 관리자 온라인 도움말"^]
