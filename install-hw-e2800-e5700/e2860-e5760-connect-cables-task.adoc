...
---
= 전원 케이블(E2860, E5760 및 DE460)을 연결합니다
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
|===
+
.. *예 A: 표준 SAS 구성의 두 개의 DE460C 디스크 셸프가 있는 컨트롤러 셸프*
+
...
.. *예 B: 표준 SAS 구성의 DE460C 디스크 셸프 1개가 있는 컨트롤러 셸프*
+
...
|===
 ...
 a| 
* 예: 전원 연결은 선반 뒤쪽에 있습니다. * image:../media/trafford_power.png["쉘프 후면의 전원 연결부"]
