...
[role="lead"]
다음 표는 EF80, EF50, E4000, EF300, EF600, E2800/EF280 및 E5700/EF570 컨트롤러의 임베디드 관리를 위한 최신 SANtricity OS 릴리스의 새로운 기능에 대해 설명합니다.
...
NOTE: SANtricity OS 12.00 릴리스는 새로운 EF80 및 EF50 올플래시 스토리지 시스템과만 호환됩니다.
...
SANtricity System Manager에서 스크립트 편집기를 사용할 수 있습니다
 a| 
SANtricity System Manager에 새로운 스크립트 편집기가 추가되었습니다. 스크립트 편집기를 사용하면 스크립트 파일을 생성 또는 편집하고, 스토리지 관리 스테이션의 로컬 디스크에 저장하거나, 디스크에서 스크립트 파일을 불러올 수 있습니다. 스크립트 편집기는 스토리지 시스템 관리를 위한 구문 검사 및 명령 실행 기능을 제공합니다. 자세한 내용은 link:https://docs.netapp.com/us-en/e-series-santricity/sm-support/use-script-editor.html["스크립트 편집기 사용"^]을 참조하십시오.
...
이 버전에는 버그 수정 사항만 포함되어 있으며 새로운 기능은 추가되지 않았습니다. 이번 릴리스의 변경 사항에 대한 자세한 내용은 E-Series SANtricity OS 11.90R5 README를 참조하십시오.
...
`-identifyDevices` 매개 변수
 a| 
SMcli에 새로운 `-identifyDevices` 매개변수가 추가되었습니다. 이 새로운 매개변수를 사용하면 Storage Arrays와 연결된 모든 SCSI 네이티브 블록 장치를 검색할 수 있습니다. 자세한 내용은 link:https://docs.netapp.com/us-en/e-series-cli/get-started/downloadable-smcli-parameters.html#identify-Devices["다운로드 가능한 SMcli 명령줄 매개 변수"^]를 참조하십시오.
...
이더넷 커널 통계
 a| 
System Manager의 View iSCSI Statistics Packages 페이지에서 새로운 Ethernet Kernel Statistics 옵션을 사용할 수 있습니다. 이 새로운 옵션을 사용하면 iSCSI 장치의 플랫폼 커널 드라이버에 대한 통계를 볼 수 있습니다. 자세한 내용은 link:https://docs.netapp.com/us-en/e-series-santricity/sm-support/view-iscsi-statistics-packages-support.html["iSCSI 통계 패키지 보기"^]을(를) 참조하십시오.
