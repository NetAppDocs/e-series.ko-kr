...
summary: 이전 버전의 문서 
---
= E-Series 하드웨어 및 SANtricity 소프트웨어 이전 버전
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
* https://docs.netapp.com/us-en/e-series-santricity-119/index.html["System Manager 도움말"^]
* https://docs.netapp.com/us-en/e-series-santricity-119/index.html["Unified Manager 도움말"^]
