...
+
*레드햇 엔터프라이즈 리눅스 8, 9 및 10 (RHEL 8, RHEL 9 및 RHEL 10)*
...
----
+
*SUSE Linux Enterprise Server 12, 15 및 16 (SLES 12, SLES 15 및 SLES 16)*
...
iscsiadm -m session
----
.. 어레이에서 iscsi 세션 상태를 확인합니다. SANtricity System Manager에서 *Settings* > *System* > *View/End iSCSISessions*로 이동합니다.
