...
---
= E-시리즈에서 파일 시스템 생성 - Linux RHEL 8, RHEL 9, RHEL 10, SLES 15 및 SLES 16 (FC 기반 NVMe)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
RHEL 8, RHEL 9, RHEL 10, SLES 15 및 SLES 16의 경우 네이티브 NVMe 장치에 파일 시스템을 생성하고 해당 파일 시스템을 마운트합니다.

.단계
. multipath -ll 명령을 실행하여 NVMe 장치 목록을 가져옵니다.
+
[listing]
----
# multipath -ll
